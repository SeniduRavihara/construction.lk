...
export function SiteFrame({ children, active }: SiteFrameProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      {/* Top Header */}
      <header className="border-b border-gray-100 py-3 px-4 md:px-8">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="hidden md:flex flex-1 max-w-2xl items-center bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
            ...
            <div className="flex items-center px-4 border-r border-gray-200 cursor-pointer hover:bg-gray-100 transition-colors h-10">
            ...
            <div className="flex items-center px-4 cursor-pointer hover:bg-gray-100 transition-colors h-10">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <div className="flex flex-col items-center cursor-pointer group relative">
              ...
              <span className="absolute -top-1 -right-1 w-4 h-4 bg-primary text-white text-[10px] flex items-center justify-center rounded-full border-2 border-white font-bold">2</span>
            </div>
      ...
      {/* Navigation Bar */}
      <nav className="border-b border-gray-100 py-2 px-4 md:px-8 hidden md:block">
              ...
              <li key={item}>
                <Link 
                  ...
                  className={`text-sm font-medium hover:text-primary transition-colors pb-2 ${
                    (item === 'Commerce' && pathname === '/') || 
                    (item === 'Suppliers' && pathname === '/search') 
                    ? 'text-primary border-b-2 border-primary' : 'text-gray-600'
                  }`}
                >
                  {item}
                </Link>
      ...
      <footer className="bg-gray-50 border-t border-gray-200 pt-16 pb-8 px-4 md:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div>
            <h3 className="font-bold text-lg mb-6 text-secondary">About Construction.lk</h3>
            <p className="text-gray-600 text-sm leading-relaxed">
              Construction.lk is a leading construction sourcing & suppliers commerce platform designed to help contractors, builders, and developers find the best materials and services globally.
            </p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-6 text-secondary">For Suppliers</h3>
            <ul className="space-y-3 text-sm text-gray-600">
              <li><Link href="#" className="hover:text-primary">About</Link></li>
              <li><Link href="#" className="hover:text-primary">For Suppliers</Link></li>
              <li><Link href="#" className="hover:text-primary">Project Management</Link></li>
              <li><Link href="#" className="hover:text-primary">Plumbing Design</Link></li>
              <li><Link href="#" className="hover:text-primary">Contractors</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-6 text-secondary">For Buyers</h3>
            <ul className="space-y-3 text-sm text-gray-600">
              <li><Link href="#" className="hover:text-primary">About Us</Link></li>
              <li><Link href="#" className="hover:text-primary">For Buyers</Link></li>
              <li><Link href="#" className="hover:text-primary">Architectural Design</Link></li>
              <li><Link href="#" className="hover:text-primary">Terms & Conditions</Link></li>
              <li><Link href="#" className="hover:text-primary">Privacy Policy</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-6 text-secondary">Newsletter Sign-up</h3>
            ...
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <p className="flex items-center gap-2"><span className="font-bold">E:</span> hello@construction.lk</p>
            </div>
          </div>
        </div>
        <div className="max-w-7xl mx-auto pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500">© 2024 Construction.lk. All rights reserved.</p>
          <div className="flex gap-6 text-sm text-gray-500">
            <Link href="#" className="hover:text-primary">Privacy</Link>
            <Link href="#" className="hover:text-primary">Legal</Link>
            <Link href="#" className="hover:text-primary">Links</Link>
          </div>
        </div>
      </footer>
    </div>
